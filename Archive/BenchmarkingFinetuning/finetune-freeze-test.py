...
def main() -> None:
    ...
    # --- TRANSFER LEARNING IMPLEMENTATION FIXED HERE ---
    ...
    # 2. Optionally unfreeze the last few transformer layers for better adaptation
    # Determine how many layers to unfreeze (you can adjust this number)
    if "esm" in config.base_model:
        num_layers_to_unfreeze = 2  # You can adjust this based on your dataset size
    ...
    # --- END OF FIXED TRANSFER LEARNING IMPLEMENTATION ---
    ...
    # Add a callback to monitor training loss
